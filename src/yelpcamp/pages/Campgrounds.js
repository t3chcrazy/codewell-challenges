...
// import Calagus from '../Assets/Camp Images/Compressed Images/Calagus Islands.jpg'
    ...
    return (
        <div>
            ...
            <div className = "container mx-auto">
                <Navbar />
                <div className = "bg-stone-200 rounded-sm px-8 py-12 flex flex-col items-start">
